...
//Params → req.params (lo que va en la URL: /menu/:id)
//ResBody → el cuerpo de la respuesta (casi siempre {}, rara vez se usa)
//ReqBody → req.body (lo que envía el cliente en POST/PUT)
//Query → req.query (lo que va después del ?: /menu?categoria=Entradas)
